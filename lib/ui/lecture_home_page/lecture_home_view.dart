...
class LectureHomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // ignore: close_sinks
    final lecture_homeBloc = BlocProvider.of<LectureHomeBloc>(context);
    // ignore: close_sinks
    ...
    return MultiBlocListener(
      listeners: [
        BlocListener<LectureHomeBloc, LectureHomeState>(
